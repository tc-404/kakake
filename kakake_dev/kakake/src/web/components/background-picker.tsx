...
function BackgroundCard({
  ...
  return (
    ...
    >
      {previewUrl ? (
        <img src={previewUrl} alt="" className="kk-bg-card__img" draggable={false} />
      ) : null}
...
/**
 * 自定义背景图选择：竖屏与横屏各一张，互不相干。
 * 点击卡片选文件，或直接把图拖到卡片上（拖入时卡片高亮）。
 */
