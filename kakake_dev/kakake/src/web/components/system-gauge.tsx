...
export function SystemGauge({
  ...
  return (
    <div
      className={cn(
        'kk-glass flex flex-col items-center justify-center rounded-[1.35rem] px-3 py-4',
        className,
      )}
    >
      ...
      {hint ? (
        <p className="mt-1.5 max-w-[14rem] text-center text-[11px] text-muted-foreground">
          {hint}
        </p>
      ) : null}
    </div>
