    ...
    <div className="kk-ambient relative flex h-[100dvh] flex-col">
      ...
      >
        <div className="mx-auto w-full max-w-3xl">
          <article
            className={cn(
              'relative overflow-hidden rounded-3xl p-6 text-slate-800 sm:p-8 md:p-10',
      ...
      {/* 底部居中玻璃药丸：安全区用 bottom 抬起，勿垫进容器以免撑高 */}
      <div
        className={cn(
          'fixed left-1/2 z-50 flex w-max max-w-[calc(100vw-1.5rem)] shrink-0 -translate-x-1/2 items-center justify-center gap-3 p-3 sm:gap-4',
          'rounded-2xl kk-glass-2 shadow-2xl shadow-slate-200/30',
      ...
      >
        <button
          ...
          className={cn(
            'h-10 shrink-0 rounded-xl border border-white/30 bg-transparent px-5 text-sm font-medium text-slate-700 sm:px-6',
        ...
        <button
          ...
          className={cn(
            'inline-flex h-10 shrink-0 items-center justify-center gap-2 rounded-xl px-6 text-sm font-semibold transition-all duration-300 sm:px-8',
            canAgree
              ? cn(
