...
export default function LoginPageInner() {
  ...
  return (
    <div className="kk-login-ambient relative flex h-full min-h-[100dvh] items-center justify-center px-4 py-8">
      ...
      <div
        className={cn(
          'relative flex w-full max-w-sm flex-col gap-6 overflow-hidden rounded-3xl',
          'border border-white/40 bg-white/20 p-8 shadow-[0_8px_32px_rgba(0,0,0,0.08)]',
          'backdrop-blur-2xl transition-transform',
      ...
      >
        ...
        <div className="relative z-10 mt-1 text-center">
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">咔咔珂</h1>
