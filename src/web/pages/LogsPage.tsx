...
export default function LogsPage() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-3">
      ...
      <div className="kk-stagger-item kk-stagger-2 flex shrink-0 flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <div className="flex shrink-0 gap-2">
          <Select value={category} onValueChange={setCategory}>
            <SelectTrigger className="h-10 w-full min-w-[7.5rem] border-white/40 bg-white/20 sm:w-[8.5rem]">
          ...
          <Select value={level} onValueChange={setLevel}>
            <SelectTrigger className="h-10 w-full min-w-[6.5rem] border-white/40 bg-white/20 sm:w-[7.5rem]">
      ...
      <div className="kk-glass kk-stagger-item kk-stagger-4 flex shrink-0 items-center gap-1 rounded-xl border border-white/40 bg-white/10 px-2 py-1.5 backdrop-blur-sm">
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'bg-white/10 backdrop-blur-sm transition-colors duration-150 hover:bg-white/20 active:scale-[0.99]',
