  ...
  return (
    <div className="min-w-0 leading-tight">
      <div className="flex items-baseline gap-2">
        <span className="kk-logo-text truncate text-xl font-semibold tracking-tight">{title}</span>
          ...
          <div className="kk-ambient-main flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            ...
            >
              <div className="flex min-w-0 items-baseline gap-1.5">
                <span className="kk-logo-text truncate font-semibold tracking-tight">{brandTitle}</span>
