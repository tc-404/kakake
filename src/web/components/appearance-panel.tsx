...
/** 只有这几项走滑动条，两组颜色交给色盘 */
type SliderKey = 'uiSpeed' | 'cardOpacity' | 'cardBlur' | 'card2Opacity' | 'card2Blur' | 'backgroundBlur';
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3.5">
        {ROWS.map(({ key, label }) => {
          ...
          return (
            <div key={key} data-tour={`ap-row-${key}`} className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-4">
