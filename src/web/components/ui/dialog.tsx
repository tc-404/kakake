...
function DialogContent({
  ...
  return (
    <DialogPortal>
      ...
      <Content
        className={cn(
          'fixed left-1/2 top-1/2 z-50 grid max-h-[min(85dvh,100dvh-2rem)] w-[calc(100vw-1.5rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 overflow-y-auto no-scrollbar rounded-2xl p-5 sm:p-6',
