...
export function buildGlobalPluginListPayload() {
  ...
  return {
    ...
    extensionPages: [...a.extensionPages, ...b.extensionPages, ...c.extensionPages],
...
export function resolveConnectionPluginKind(connectionId?: string): 'kakake' | 'gf' | 'wx' | undefined {
